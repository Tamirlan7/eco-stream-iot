...
import com.tami.usageservice.client.DeviceClient;
import com.tami.usageservice.client.UserClient;
import com.tami.usageservice.dto.DeviceDto;
import com.tami.usageservice.dto.UsageDto;
import com.tami.usageservice.dto.UserDto;
import com.tami.usageservice.kafka.event.AlertingEvent;
import com.tami.usageservice.kafka.event.EnergyUsageEvent;
import com.tami.usageservice.model.Device;
import com.tami.usageservice.model.DeviceEnergy;
...
public class UsageService {
    ...
    public UsageDto getXDaysUsageForUser(Long userId, int days) {
        ...
        from(bucket: "%s")
          ...
          |> group(columns: ["deviceId"])
          |> sum(column: "_value")
        """, influxBucket, start.toString(), now, deviceFilter);
